...
def main(args):
    ...
    happy_params = list(decoder.S_happy_i.parameters()) + list(
        decoder.S_happy_f.parameters()) + list(
            decoder.S_happy_o.parameters()) + list(
                decoder.S_happy_c.parameters())
    sad_params = list(decoder.S_sad_i.parameters()) + list(
        decoder.S_sad_f.parameters()) + list(
            decoder.S_sad_o.parameters()) + list(decoder.S_sad_c.parameters())
    angry_params = list(decoder.S_angry_i.parameters()) + list(
        decoder.S_angry_f.parameters()) + list(
            decoder.S_angry_o.parameters()) + list(
                decoder.S_angry_c.parameters())
...
def train_emotion(encoder, decoder, optimizers, criterion, data_loaders, tags,
                  log_step):
    decoder.train()
    encoder.train()
