...
class AttentionLayer(Layer):
    ...
    This class imported from https://github.com/thushv89/attention_keras/blob/master/layers/attention.py
    https://github.com/thushv89/attention_keras/commit/26e7c34a021a9a610787eccf486a11d93190cee1
     """
    ...
    def call(self, inputs, verbose=False):
        ...
        def energy_step(inputs, states):
            ...
            e_i = K.reshape(
                K.dot(reshaped_Ws_plus_Uh, self.V_a), (-1, en_seq_len))
            # <= batch_size, en_seq_len
            e_i = K.softmax(e_i)
