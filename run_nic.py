...
def main(args):
    ...
    result_path = checkpoints_path + '/nic/result'
    ...
    if not os.path.exists(checkpoints_path + '/nic'):
        os.makedirs(checkpoints_path + '/nic')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='NIC Indonesia: Generate Image Captioning')
    parser.add_argument(
        '--load_model',
        type=int,
        default=0,
